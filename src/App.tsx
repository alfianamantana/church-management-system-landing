...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Footer */}
      <footer className="border-t bg-secondary/30 border-border/40  px-4 py-12">
        <div className="container mx-auto">
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{t('footer.brand.description')}</p>
            </div>
            <div>
              <h3 className="mb-4 text-sm font-semibold text-foreground">{t('footer.product.title')}</h3>
            ...
            <div>
              <h3 className="mb-4 text-sm font-semibold text-foreground">{t('footer.support.title')}</h3>
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-sm text-muted-foreground hover:text-foreground">
